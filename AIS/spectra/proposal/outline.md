...
7) **3.0 Phase I Statement of Work (Base and Option)**
   - Table 4 (Base, 6 months):
     ...
     - T3 Simulation Harness + Scenario Packs (M3–M4): RF payload-in-the-loop integration leveraging IA's SDA/EW modsim expertise; EWIRDB-like/EMoP-like synthetic RF scene generation; EW attack injectors; uncertainty calibration plan (SIERO-like methods); observation and event data flow validation.
